...
export default class SlideNav extends Slide {
  ...
  addArrowEvent() {
    // Criar window.event e verficiar se as teclas são arrowLeft
    // ou arrowRight, se forem, usar a função de ir e vir
    this.prevElement.addEventListener('click', this.activePrevSlide);
    this.nextElement.addEventListener('click', this.activeNextSlide);
  }

  checkKey(event) {
    if (event.keyCode === 37) this.activePrevSlide();
    else if (event.keyCode === 39) this.activeNextSlide();
  }
